...
`include "incl/ISA_Ops.svh"
    ...
    initial begin
       $display("[INFO] Testing instruction decode");
        ...
        word2 = {ISA_OP_ADD_IM, 8'b0, 8'b1101, 8'b1, ISA_OP_NOP, 8'b0, 8'b0, 8'b0, 3'b00, 8'b0 };
